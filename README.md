...
### 2022-07-04
* 重磅更新，后续可能持续一段时间优化这个功能。
* 新增功能，可查看游戏内角色橱窗展示的角色属性面板啦。并进行了简单的圣遗物有效词条计算，和评级。用过特瓦特和工坊的同学，对这个功能肯定都不陌生啦。懂的都懂呢。
...
* 命令： 签到
![image](https://user-images.githubusercontent.com/41506567/177092958-cebe4f3a-c036-4a62-9009-7f10a358d81b.png)


### 2022-0609
* 更新yss命令，得到的角色信息卡片的卡片样式，并添加角色所装备武器的信息，添加世界探索渊下宫及层岩巨渊的信息，添加诚哥壶的信息。
![角色信息卡片](https://user-images.githubusercontent.com/41506567/172739110-a622af45-1b27-4196-8ddf-326bec291945.jpg)
